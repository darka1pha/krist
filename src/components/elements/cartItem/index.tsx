...
const CartItem = ({ brand, id, name, price, qty, image }: CartItemProps) => {
	return (
		<div className='p-4 border-b border-gray-[#f6f6f6] grid grid-cols-12 grid-flow-row'>
			<span className='h-20 overflow-hidden relative rounded-lg col-span-1'>
				<Image
					src={image}
					alt='product image'
					layout='fill'
			...
			<span className='px-2 col-span-5 ml-2'>
			...
			<span className='grid col-span-1 items-center justify-items-end'>
